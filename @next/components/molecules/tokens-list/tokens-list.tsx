...
export const TokensList: React.FC = () => {
  ...
  const handleSelectedToken = (rawToken: TokenInfoInterface): void => {
  ...
  const handleSelect = (symbol: string, rawToken?: any): void => {
  ...
  return (
    <div className="absolute flex flex-col gap-2.5 p-3 mt-2 w-[343px] md:w-[530px] max-h-[800px] bg-[#2E334D] rounded-2xl overflow-hidden">
      ...
      <div className="max-h-[340px] flex flex-col gap-2 overflow-y-auto thin-scrollbar">
        ...
        {!loading && error && (
          <div className="px-4 py-6 text-center text-red-300 text-sm">
            {error}
          </div>
        )}
